...
export interface IGetTrendZoneOfficesByCityFx {
  city: string
  lang: string
}

export interface ITrendZoneAddressData {
...
export interface IPickupAddressItemProps {
  addressItem: ITrendZoneAddressData
  handleSelectAddress: (arg0: IAddressBBox, arg1: IAddressPosition) => void
  handleChosenAddressData: (arg0: Partial<ITrendZoneAddressData>) => void
}
